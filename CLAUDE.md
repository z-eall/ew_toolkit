# EW Toolkit — Standing Rules

Hub-wide rules for every Tool this repo ever hosts (currently `ewp_validator`, Tool #1). Tool-specific rules live in that Tool's own `CLAUDE.md` — see [ewp_validator/CLAUDE.md](ewp_validator/CLAUDE.md).
