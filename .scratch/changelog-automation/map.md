...
- [What should a generated release-notes entry look like?](issues/03-release-notes-format.md) — Sections grouped by the validator's own diagnostic-category vocabulary (Data entry reference, Format lint, Value group, etc.), not a generic Fixed/Added/Changed split or flat list — reads instantly to users of the Problems-panel filters.
